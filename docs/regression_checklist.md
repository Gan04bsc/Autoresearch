...
- 是否生成 `kb/index.md`、`field-map.md`、`technical-frontier.md`、`reading-plan.md`、
  `innovation-opportunities.md`、`matrices/method-matrix.md` 和
  `matrices/benchmark-matrix.md`。
